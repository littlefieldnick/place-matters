...
/* harmony import */ var _auth_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth.guard */ "./src/app/components/admin/auth.guard.ts");
/* harmony import */ var _dash_dash_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dash/dash.component */ "./src/app/components/admin/dash/dash.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./login/login.component */ "./src/app/components/admin/login/login.component.ts");
/* harmony import */ var _registration_registration_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./registration/registration.component */ "./src/app/components/admin/registration/registration.component.ts");
/* harmony import */ var _admin_routing__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./admin.routing */ "./src/app/components/admin/admin.routing.ts");
/* harmony import */ var _app_material_material_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../app-material/material.module */ "./src/app/app-material/material.module.ts");
...
/* harmony import */ var _isSignedIn_guard__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./isSignedIn.guard */ "./src/app/components/admin/isSignedIn.guard.ts");
...
AdminModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function AdminModule_Factory(t) { return new (t || AdminModule)(); }, providers: [_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"], _isSignedIn_guard__WEBPACK_IMPORTED_MODULE_11__["IsSignedInGuard"]], imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_10__["LayoutModule"],
            _angular_flex_layout__WEBPACK_IMPORTED_MODULE_9__["FlexLayoutModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
            _app_material_material_module__WEBPACK_IMPORTED_MODULE_8__["MaterialModule"],
            _admin_routing__WEBPACK_IMPORTED_MODULE_7__["AdminRoutingModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AdminModule, { declarations: [_dash_dash_component__WEBPACK_IMPORTED_MODULE_4__["DashComponent"], _login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _registration_registration_component__WEBPACK_IMPORTED_MODULE_6__["RegistrationComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_10__["LayoutModule"],
        _angular_flex_layout__WEBPACK_IMPORTED_MODULE_9__["FlexLayoutModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
...
/* harmony import */ var _registration_registration_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./registration/registration.component */ "./src/app/components/admin/registration/registration.component.ts");
/* harmony import */ var _dash_dash_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dash/dash.component */ "./src/app/components/admin/dash/dash.component.ts");
/* harmony import */ var _auth_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth.guard */ "./src/app/components/admin/auth.guard.ts");
/* harmony import */ var _isSignedIn_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./isSignedIn.guard */ "./src/app/components/admin/isSignedIn.guard.ts");
...
class AuthGuard {
    ...
    canActivate(route, state) {
        return this.auth.isAuthenticated().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(isAuth => {
            if (isAuth) {
                return true;
            }
            else {
...
AuthGuard.ɵfac = function AuthGuard_Factory(t) { return new (t || AuthGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"])); };
...
function DashComponent_mat_grid_tile_4_mat_card_6_Template(rf, ctx) { if (rf & 1) {
...
class DashComponent {
    constructor(breakpointObserver, sanitizer, iconRegistry) {
...
DashComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashComponent, selectors: [["dash"]], decls: 6, vars: 3, consts: [[1, "grid-container"], [1, "mat-h1"], ["cols", "4", "rowHeight", "250px"], [3, "colspan", "rowspan", 4, "ngFor", "ngForOf"], [3, "colspan", "rowspan"], ["class", "dashboard-card-content", 3, "matTooltip", 4, "ngFor", "ngForOf"], [1, "dashboard-card-content", 3, "matTooltip"], [1, "card-icon", 3, "svgIcon"]], template: function DashComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DashComponent, [{
    ...
    }], function () { return [{ type: _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_2__["BreakpointObserver"] }, { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"] }, { type: _angular_material_icon__WEBPACK_IMPORTED_MODULE_4__["MatIconRegistry"] }]; }, null); })();
...
IsSignedInGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: IsSignedInGuard, factory: IsSignedInGuard.ɵfac });
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _forms_login_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../forms/login.form */ "./src/app/forms/login.form.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
...
function LoginComponent_mat_card_7_li_4_Template(rf, ctx) { if (rf & 1) {
...
function LoginComponent_div_8_div_4_Template(rf, ctx) { if (rf & 1) {
...
function LoginComponent_div_8_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "input", 14);
} if (rf & 2) {
    const control_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("formControlName", control_r4.modelProperty);
} }
function LoginComponent_div_8_mat_error_7_Template(rf, ctx) { if (rf & 1) {
...
class LoginComponent {
    ...
    loginUser() {
        ...
        if (this.loginForm.valid) {
            this.authService.loginUser(this.loginForm.get("email").value, this.loginForm.get("password").value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(err => {
                this.displayServerError(err);
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])([]);
            })).subscribe((response) => {
                if (response["success"]) {
                    this.snackBar.dismiss(); //dismiss place-matters-server error if open
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["login"]], decls: 11, vars: 4, consts: [["fxLayout", "row", "fxLayoutAlign", "center", 2, "padding-top", "10px"], ["fxLayout", "column", "fxFlex", "50%", "fxLayoutGap", "20px"], [1, "mat-headline", 2, "color", "indigo"], ["novalidate", "", 3, "formGroup", "ngSubmit"], ["style", "background-color: rgba(217,83,79,0.5);", 4, "ngIf"], ["style", "padding-top:3px", 4, "ngFor", "ngForOf"], ["mat-raised-button", "", "color", "primary", 3, "disabled"], [2, "background-color", "rgba(217,83,79,0.5)"], [4, "ngFor", "ngForOf"], [2, "padding-top", "3px"], ["fxFlex", "100%", "appearance", "outline"], [4, "ngIf", "ngIfElse"], ["inputBlock", ""], ["type", "password", "matInput", "", 3, "formControlName"], ["type", "text", "matInput", "", 3, "formControlName"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function LoginComponent_Template_form_ngSubmit_6_listener() { return ctx.loginUser(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: _services_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }, { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_6__["MatSnackBar"] }]; }, null); })();
...
function RegistrationComponent_mat_card_7_li_3_Template(rf, ctx) { if (rf & 1) {
...
function RegistrationComponent_mat_card_7_Template(rf, ctx) { if (rf & 1) {
...
function RegistrationComponent_div_8_div_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](1, "input", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const control_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpropertyInterpolate"]("formControlName", control_r4.modelProperty);
} }
function RegistrationComponent_div_8_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "input", 11);
} if (rf & 2) {
    const control_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpropertyInterpolate"]("formControlName", control_r4.modelProperty);
} }
function RegistrationComponent_div_8_mat_error_7_Template(rf, ctx) { if (rf & 1) {
    ...
    registerUser() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (this.registerForm.valid) {
                ...
                this.authService.register(this.registerForm.get("firstName").value, this.registerForm.get("lastName").value, this.registerForm.get("email").value, this.registerForm.get("password").value).then((data) => {
                    if (!data)
                        return;
                    this.authService.loginUser(this.registerForm.get("email").value, this.registerForm.get("password").value).subscribe(data => {
                        if (data)
                            this.router.navigateByUrl("/admin/dash");
                    }, Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(err)));
                });
            }
        });
    }
}
RegistrationComponent.ɵfac = function RegistrationComponent_Factory(t) { return new (t || RegistrationComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"])); };
RegistrationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: RegistrationComponent, selectors: [["registration"]], decls: 11, vars: 3, consts: [["fxLayout", "row", "fxLayoutAlign", "center", 2, "padding-top", "10px"], ["fxLayout", "column", "fxFlex", "50%", "fxLayoutGap", "20px"], [1, "mat-headline", 2, "color", "indigo"], ["novalidate", "", 3, "formGroup", "ngSubmit"], [4, "ngIf"], [4, "ngFor", "ngForOf"], ["mat-raised-button", "", "color", "primary"], ["fxFlex", "100%", "appearance", "outline"], [4, "ngIf", "ngIfElse"], ["inputBlock", ""], ["type", "password", "matInput", "", 3, "formControlName"], ["type", "text", "matInput", "", 3, "formControlName"]], template: function RegistrationComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function RegistrationComponent_Template_form_ngSubmit_6_listener() { return ctx.registerUser(); });
...
class LoginForm extends _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormGroup"] {
    ...
    getFormValidationMessages() {
        let messages = [];
        Object.values(this.controls).forEach(c => messages.push(...c.getValidationMessages()));
        return messages;
    }
}
...
class RegistrationForm extends _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormGroup"] {
    constructor() {
        super({
